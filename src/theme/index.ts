...
const getDesignTokens = (mode: PaletteMode): ThemeOptions => ({
  palette: {
    ...
    secondary: {
      light: brand[100], // Using brand 100 for warmth in secondary
      main: brand[300],
      dark: brand[500],
    },
    error: {
    ...
    background: {
      default: mode === 'dark' ? '#070707' : '#fff', // Deeper black for higher contrast
      paper: mode === 'dark' ? '#111' : gray[50],
    },
    text: {
      primary: mode === 'dark' ? '#fff' : gray[900],
      secondary: mode === 'dark' ? alpha('#fff', 0.7) : gray[600],
    },
    divider: mode === 'dark' ? alpha('#fff', 0.1) : alpha(gray[300], 0.5),
  },
  typography: {
