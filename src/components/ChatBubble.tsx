        ...
        <ReactMarkdown
            ...
            components={{
                ...
                a: ({ node, ...props }) => {
                    ...
                    if (isInternal) {
                        return (
                            <Box component={Link} href={props.href || "#"} sx={linkStyle} {...props}>
                                {props.children}
                            </Box>
                        );
                    }
                    ...
                    return (
                        <Box component="a" target="_blank" rel="noopener noreferrer" sx={linkStyle} {...props}>
    ...
    return (
        <>
            <AnimatePresence>
                {isVisible && !isOpen && (
                    <Box
                        sx={{ position: "fixed", bottom: { xs: 20, md: 30 }, right: { xs: 20, md: 30 }, zIndex: 2000 }}
                    >
                        <motion.div
            ...
            <AnimatePresence>
                {isOpen && (
                    ...
                    >
                        ...
                        {/* Messages Area */}
                        <Box
                            sx={{ flex: 1, p: 2, overflowY: "auto", display: "flex", flexDirection: "column", gap: 2 }}
                        >
                            {messages.length === 0 && (
