...
// Raspberry Pi Icon Path
const RASPBERRY_PI_PATH =
    ...
    logo: (
      <Box
        sx={(theme) => ({
          width: 48,
          height: 48,
          backgroundColor: (theme.palette.secondary as any).main
            ? `${(theme.palette.secondary as any).main}80`
            : '#9c27b080', // Fallback
          borderRadius: 2,
          display: 'flex',
          alignItems: 'center',
