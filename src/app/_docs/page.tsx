  ...
  return (
    <Box sx={{ maxWidth: 800, mx: "auto", py: 8 }}>
      ...
      >
        <Typography
          variant="h2"
          sx={{ fontWeight: 800, mb: 4, letterSpacing: -1 }}
        >
        ...
        <Typography
          ...
          sx={{ mb: 8, fontWeight: 400, lineHeight: 1.6 }}
        >
          Referencia visual de los componentes de interfaz de usuario y el
          sistema de iconografía nativo de MUI utilizado en LogOS.
        </Typography>
          ...
          <Stack direction="row" spacing={3} alignItems="center">
            ...
            <Box>
              ...
              <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
                Consulta la documentación completa de Material UI Icons para ver
